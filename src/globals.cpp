...
// ===================== APP STATES =====================
const String appStateNames[] = { "txt", "filewiz", "usb", "bt", "settings", "tasks", "calendar", "journal", "lexicon", "script" , "loader", "pomodoro" }; // App state names
#if !OTA_APP // POCKETMAGE_OS
const unsigned char *appIcons[12] = { _homeIcons2, _homeIcons3, _homeIcons4, _homeIcons5, _homeIcons6, taskIconTasks0, _homeIcons7, _homeIcons8, _homeIcons9, _homeIcons11, _homeIcons10, taskIconTasks0}; // App icons (using tasks icon as placeholder for pomodoro)
#endif
